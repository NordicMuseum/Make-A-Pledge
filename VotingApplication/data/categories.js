    ...
    actions: [
      {
        ...
        learnMoreText: '<img src="images/objects/NM.0201803.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Livtröja från Hälsingland, mitten av 1800-talet. Möjligen är bålen tagen från en äldre tröja som har skarvats i med annat ylletyg på axlarna. NM.0201803</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<img src="images/objects/NM.0273621A-B.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Vinternäbbskor från Lappland, tidigt 1900-tal. NM.0273621A-B</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<img src="images/objects/NM.0240612.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Lappade timmerhuggarbyxor från Töre i Norrbotten, tidigt 1900-tal. NM.0240612</p>',
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<img src="images/objects/NM.0328486A-D.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Cykel, tillverkad i Stockholm 1960. NM.0328486A-D</p>',
  ...
  'Purchases': {
    ...
    actions: [
      ...
      },
      {
        ...
        localOrgLink: [],
        learnMoreText: '<img src="images/objects/NM.0059952.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Täljstenslampa från Grönland som eldas med sälfett, sent 1800-tal. Lampan höll länge och var jämförelsevis energisnål. NM.0059952</p>',
        learnMoreLink: 'https://malin.elledecoration.se/att-inreda-hallbart'
      }
    ]
  },
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<img src="images/objects/NM.0126345.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Rana (vävt tygstycke) från Vittangi i Lappland, innan 1915. Tygstycken har använts för att täta eller för att trivas med lägre inomhustemperatur NM.0126345</p>',
