  ...
  'Clothing': {
    ...
    actions: [
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0273621A-B.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Vinternäbbskor från Lappland, tidigt 1900-tal. NM.0273621A-B</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0240612.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Lappade timmerhuggarbyxor från Töre i Norrbotten, tidigt 1900-tal. NM.0240612</p>',
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0328486A-D.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Cykel, tillverkad i Stockholm 1960. NM.0328486A-D</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NMA.0058040.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Turistbuss i Holmajärvi, Norrbotten, 1946. NMA.0058040</p>',
        learnMoreLink: 'https://voxnadalen.naturskyddsforeningen.se/gron-guide/res-klimatsmart'
      },
      {
        id: 'Airtravel',
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NMA.0046474.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Lillehammer tågstation, 1939. Foto: Gunnar Lundh. NMA.0046474</p>',
        learnMoreLink: 'https://voxnadalen.naturskyddsforeningen.se/gron-guide/res-klimatsmart'
      }
    ]
  },
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0328242.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Smörkärna tillverkad i Gävle, 1910-tal. Köptes begagnad av en småländsk torparfamilj och användes under 1930- och 1940-tal. NM.0328242</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0115566.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Spräckt och lagad skål från Östergötland, innan 1910. NM.0115566</p>',
        learnMoreLink: 'https://malin.elledecoration.se/att-inreda-hallbart'
      },
      {
        id: 'Durability',
  ...
  'Living': {
    ...
    actions: [
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0319074.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Tvål, tillverkad i Nyköping 1970. NM.0319074</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0223731A-B.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Nordpolsspelet, tillverkat i Tyskland för svensk publik, 1890-tal. NM.0223731A-B</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      }
    ]
  },
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0403281.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Kornprov från Hämra i Ångermanland, 1896. NM.0403281</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      },
      {
        id: 'Foodwaste',
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NM.0311599.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Reklamskylt för lingonsylt och lingonsaft från Kalix. NM.0311599</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      },
      {
        id: 'Locallyproduced',
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Exempel ur Nordiska museets samlingar</h2><img src="/make-a-pledge/images/objects/NMA.0062054.jpg" height="190" class="learnMoreImage"/><p class="learnMoreText">Potatisskörd i Åre, Jämtland 1943. Foto Gunnar Lundh. NMA.0062054</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      }
    ]
  }
