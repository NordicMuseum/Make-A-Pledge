  ...
  'Clothing': {
    ...
    actions: [
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0273621A-B.jpg" class="learnMoreImage"/><p class="learnMoreText">Winter  shoes from Lapland, early 1900s. NM.0273621A-B</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0240612.jpg" class="learnMoreImage"/><p class="learnMoreText">Patched logging trousers from Töre in Norrbotten, early 1900s. NM.0240612</p>',
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0328486A-D.jpg" class="learnMoreImage"/><p class="learnMoreText">Bicycle, manufactured in Stockholm 1960. NM.0328486A-D</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NMA.0058040.jpg" class="learnMoreImage"/><p class="learnMoreText">Tourist bus in Holmajärvi, Norrbotten, 1946. NMA.0058040</p>',
        learnMoreLink: 'https://voxnadalen.naturskyddsforeningen.se/gron-guide/res-klimatsmart'
      },
      {
        id: 'Airtravel',
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NMA.0046474.jpg" class="learnMoreImage"/><p class="learnMoreText">Lillehammer train station, 1939. Foto: Gunnar Lundh. NMA.0046474</p>',
        learnMoreLink: 'https://voxnadalen.naturskyddsforeningen.se/gron-guide/res-klimatsmart'
      }
    ]
  },
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0328242.jpg" class="learnMoreImage"/><p class="learnMoreText">Butter churn made in Gävle, 1910s. Purchased in used condition by a family in Småland and used during the 1930s and 1940s. NM.0328242</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0115566.jpg" class="learnMoreImage"/><p class="learnMoreText">Cracked and repaired bowl from Östergötland, before 1910. NM.0115566</p>',
        learnMoreLink: 'https://malin.elledecoration.se/att-inreda-hallbart'
      },
      {
        id: 'Durability',
  ...
  'Living': {
    ...
    actions: [
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0319074.jpg" class="learnMoreImage"/><p class="learnMoreText">Bar of soap, manufactured in Nyköping 1970. NM.0319074</p>',
      ...
      },
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0223731A-B.jpg" class="learnMoreImage"/><p class="learnMoreText">The North Pole Game, made in Germany for Swedish audiences, 1890s. NM.0223731A-B</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      }
    ]
  },
    ...
    actions: [
      {
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0403281.jpg" class="learnMoreImage"/><p class="learnMoreText">Grain sample from Hämra in Ångermanland, 1896. NM.0403281</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      },
      {
        id: 'Foodwaste',
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NM.0311599.jpg" class="learnMoreImage"/><p class="learnMoreText">Advertising sign for lingonberry jam and lingonberry juice from Kalix. NM.0311599</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      },
      {
        id: 'Locallyproduced',
        ...
        localOrgText: 'ExampleLocalOrg',
        localOrgLink: ['http://www.example.com/'],
        learnMoreText: '<h2>Examples from the Nordic Museum collections</h2><img src="/make-a-pledge/images/objects/NMA.0062054.jpg" class="learnMoreImage"/><p class="learnMoreText">Potato harvest in Åre, Jämtland 1943. Foto Gunnar Lundh. NMA.0062054</p>',
        learnMoreLink: 'http://www.stockholm.se/ByggBo/Leva-Miljovanligt/Klimatsmart-i-hemmet'
      }
    ]
  }
